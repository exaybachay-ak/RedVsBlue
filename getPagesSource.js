...
function DOMtoString(document_root) {
    ...
    */
    ...
    /** Step 2C
    *   Create variable to track transparency state
    */    
    ...
    */
    ...
    var bgImage = chrome.extension.getURL("1.jpg");
    ...
    var buttonImage = chrome.extension.getURL("r2.png");
    ...
    var transImage = chrome.extension.getURL("b1.png");
    ...
    $( ".toggleme" ).each(function(index) {
        $(this).on("click", function(){
            ...
            /**
                ...
                clipboard.style.cssText = 'opacity\:.33;overflow\:auto;z-index\:120000111;position\:fixed;top\:9px;left\:520px;height\:35px;padding-top\:4px;padding-left\:10px;padding-right\:18px;color\:white;background-color\:transparent;background:black;border-radius\:6px;border\:3px solid gray;box-shadow\:1px 1px 0\.5px #555555;font-family\:Arial;font-size\:12px;-webkit-font-smoothing\:antialiased;line-height\:17px';
            }
            **/
